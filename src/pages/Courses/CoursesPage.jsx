    ...
    const courses = [
        {
          ...
          description: "دورات شاملة لتعليم قواعد اللغة العربية، تهدف إلى تنمية مهارات الطلاب اللغوية في النحو والصرف والبلاغة والنصوص الشعرية والنثرية والإملاء - مقررات عرب: 101، 102، 201، 202، 301، 302.",
          price:"5DB لكل حصة",
        ...
        },
        {
            ...
            description: "القدرات اللفظية",
            price:"150 SAR للحصة",
            extra:"1000 SAR للنماذج",
            dateTime: 'متاحة طوال العام',
            status:'...جاري الإنشاء'
        },
        {
